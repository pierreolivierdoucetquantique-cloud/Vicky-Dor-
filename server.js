...
app.post('/api/bookings', requireAuth, async (req, res) => {
  console.log('🔥🔥🔥 [TEST-DIAGNOSTIC] Route /api/bookings atteinte — ' + new Date().toISOString());
  try {
    ...
    console.log('🔥🔥🔥 [TEST-DIAGNOSTIC] Réservation insérée (id=' + result.lastInsertRowid + '), appel de sendConfirmationEmails...');
